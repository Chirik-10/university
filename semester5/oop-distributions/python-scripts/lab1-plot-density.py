...
empirical = np.loadtxt('/content/drive/MyDrive/Colab/empirical_density.txt')
theoretical = np.loadtxt('/content/drive/MyDrive/Colab/theoretical_density.txt')
#empirical = np.loadtxt('/content/drive/MyDrive/Colab/empirical_mix_density.txt')
#theoretical = np.loadtxt('/content/drive/MyDrive/Colab/theoretical_mix_density.txt')
