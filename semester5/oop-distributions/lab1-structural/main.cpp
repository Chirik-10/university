...
void demo_base_distribution() {
    printf("\nДемонстрация основного распределения: \n");
    base_distribution d;
    ...
    printf("Форма nu (больше нуля): "); scanf_s("%lf", &d.nu);
    if (d.lambda <= 0 || d.nu <= 0) {
...
void demo_mixture_distribution() {
    ...
    printf("Форма nu1 (больше нуля): "); scanf_s("%lf", &mix.d1.nu);
    ...
    printf("Форма nu2 (больше нуля): "); scanf_s("%lf", &mix.d2.nu);
...
int main() {
    ...
    do {
        printf("\nМЕНЮ\n");
        printf("1. Демонстрация основного распределения\n");
        printf("2. Демонстрация смеси распределений\n");
        printf("3. Запуск тестов\n");
        printf("0. Выход\n");
