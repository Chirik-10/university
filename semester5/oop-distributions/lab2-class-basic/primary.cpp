...
Primary::Primary(FILE* in) {
    load(in);
}

// Обновление вспомогательных констант
void Primary::const_update() {
    double beta_val = beta_function(form - 0.5, 0.5);
    normalization_const = 1.0 / (scale * beta_val);
}
